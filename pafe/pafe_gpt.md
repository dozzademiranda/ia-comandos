...
Quando a síntese direta com `edge-tts` falhar por DNS, rede ou egress bloqueado, verificar as rotas realmente disponíveis e autorizadas antes de declarar indisponibilidade.

É proibido substituir a voz neural por Piper não autorizado, eSpeak, pyttsx3, Festival, gTTS robótico ou outro fallback metálico.
...
14. conferir quantidade de arquivos, duração e integridade;
...
Não entregar voz robótica. Não declarar MP3 gerado sem arquivo físico validado.

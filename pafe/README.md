...
4. /pafe 0 ou /pafe <letra> — executa apenas a fase indicada; 0 ou letras de A a F (exemplos: /pafe 0, /pafe B).
...
9. Regra de desambiguação: dígito 0 ou letra de A a F é fase; palavra é módulo.

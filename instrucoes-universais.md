...
Se houver conflito entre espelhos, comparar versão interna e conteúdo; não escolher por data externa, nome ou tamanho.
...
7. Quando a resposta apenas informar algo simples, ainda preferir uma continuação útil e específica se existir; evitar ofertas vagas como “posso ajudar em algo mais”.
...
10. Se houver mais de três caminhos, sintetizar os três mais úteis; não transferir ao usuário a tarefa de formular uma quarta opção.
11. A tecla escolhida vale apenas para o menu mais recente e não altera comandos canônicos nem preferências permanentes por si só.

Exemplo:
```text
[CONTINUIDADE — RESPONDA SÓ COM 1 TECLA]
1 — Recomendada: aplicar a correção nos três espelhos e validar.
2 — Mostrar apenas o diff antes de alterar.
3 — Auditar também arquivos legados relacionados.
```

## 5. Carregar antes de editar
...
2. Não publicar dados pessoais sensíveis, detalhes de casos privados, estratégias confidenciais ou credenciais.
...
7. continuidade de uma tecla oferecida quando útil.
